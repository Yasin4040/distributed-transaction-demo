...
CREATE TABLE IF NOT EXISTS t_order (
    ...
    status TINYINT DEFAULT 0 COMMENT '状态：0-初始化 1-已确认 2-已取消',
...
-- TCC事务日志表
CREATE TABLE IF NOT EXISTS t_tcc_transaction_log (
    xid VARCHAR(64) PRIMARY KEY COMMENT '事务ID',
    business_type VARCHAR(32) NOT NULL COMMENT '业务类型',
    business_id VARCHAR(64) NOT NULL COMMENT '业务ID',
    status TINYINT DEFAULT 1 COMMENT '状态：1-TRYING 2-CONFIRMING 3-CANCELLING 4-CONFIRMED 5-CANCELLED',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='TCC事务日志表';
